...
//            "test image content".getBytes());
  ...
  void createProduct_Success() throws Exception {
    when(productService.createProduct(any(Product.class), any())).thenReturn(testProduct);
...
//                .file(testImage)
    ...
    verify(productService).createProduct(any(Product.class), any());
  }
...
//                .file(testImage)
  ...
  void updateProduct_Success() throws Exception {
    when(productService.updateProduct(eq(1L), any(Product.class), any())).thenReturn(testProduct);
...
//                .file(testImage)
  ...
  void getProductsByCategory_EmptyCategory_ShouldReturnEmptyList() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/v1/products/category/{category}", "NonExistentCategory"))
        .andExpect(status().isOk())
  ...
  void createProduct_WithoutRequiredFields_ShouldReturnBadRequest() throws Exception {
    createRequestDto.setTitle(null);
  ...
  void createProduct_WithInvalidPrice_ShouldReturnBadRequest() throws Exception {
    createRequestDto.setPrice(new Price(-100, CurrencyUnit.TOMAN)); // Negative price
